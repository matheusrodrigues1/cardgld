...
const SubPage = () => {
  return (
    <div className="flex flex-col items-center justify-center w-full h-full bg-zinc-900">
      ...
      <div className="flex flex-col items-center justify-center w-[30rem] h-[37rem] rounded-lg bg-black">
        <Image
          src={Sub01}
          className="h-[14rem] w-[20rem] rounded-lg"
          alt="img"
        />
        ...
        <p className="text-zinc-300 text-2xl font-normal text-center pr-10 pl-10 mt-6">
      ...
      <div className="flex flex-col items-center justify-center w-[30rem] h-[37rem] rounded-lg bg-black mt-5">
        <Image
          src={Sub02}
          className="h-[14rem] w-[20rem] rounded-lg"
          alt="img"
